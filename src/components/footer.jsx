...
const Footer = () => {
  return (
    <footer className="bg-white rounded-lg shadow-sm dark:bg-gray-900 m-4 relative">
      {/* Big logo positioned at left center */}
      <div className="absolute left-8 top-1/2 transform -translate-y-1/2">
        <a href="https://flowbite.com/" className="flex items-center">
          <img 
            src={logoImage} 
            className="h-24 md:h-32 lg:h-40"  // Increased size with responsive scaling
            alt="Anna Logo" 
          />
        </a>
      </div>

      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8 pl-32 md:pl-40 lg:pl-48"> {/* Added padding to accommodate logo */}
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © 2025 <a href="https://flowbite.com/" className="hover:underline">Anna™</a>. All Rights Reserved.<br />Kirtan Shrestha
        </span>
      </div>
    </footer>
  );
