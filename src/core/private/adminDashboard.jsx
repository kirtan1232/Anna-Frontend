    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            const [profileData, usersData, lessonsData, songsData, supportData] = await Promise.all([
                fetchWithToken("http://localhost:3000/api/auth/profile", "Failed to fetch profile"),
                fetchWithToken("http://localhost:3000/api/auth/users", "Failed to fetch users"),
                fetchWithToken("http://localhost:3000/api/quiz/getAllQuizzes", "Failed to fetch lessons"),
                fetchWithToken("http://localhost:3000/api/songs/getsongs", "Failed to fetch songs"),
                fetchWithToken("http://localhost:3000/api/support", "Failed to fetch support records")
            ]);
